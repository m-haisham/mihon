        ...
        Scaffold(
            ...
            Box(
                ...
                QrScanner(
                    ...
                    onCompletion = { raw -> screenModel.onScan(raw, errorMessage) },
                    imagePickerHandler = {},
                    onFailure = { screenModel.setError(errorMessage) },
...
@Composable
private fun CameraPermissionDeniedContent(modifier: Modifier) {
    Column(
        modifier = modifier,
        ...
        screenModelScope.launch {
            when (val result = parser.parse(raw)) {
                ...
                is QrPayloadParser.ScanResult.Chunk -> {
                    ...
                    mutableState.update {
                        it.copy(scannedCount = chunks.size, totalExpected = result.total)
                    }
